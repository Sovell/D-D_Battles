...
import { createManualBattleSave, type AppScreen } from "./app/session-storage";
...
export function App() {
  ...
  function saveBattle() {
    createManualBattleSave(session.seed, session.heroIds, state);
  ...
  if (screen === "builder") return <ScenarioBuilder onLaunch={launch} onBack={() => setScreen("menu")} />;

...
function UnitInspector({ state, unit }: { state: BattleState; unit: Combatant }) {
  return <div className="unit-inspector">
    ...
    <div className="unit-stat-grid"><Stat label="DC" value={unit.defenseClass} /><Stat label="SZYBKOŚĆ" value={unit.speed} /><Stat label="INICJATYWA" value={unit.initiative} /><Stat label="ATAK" value={`+${unit.attackBonus}`} /></div>

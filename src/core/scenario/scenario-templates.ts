...
export const scenarioTemplates: ScenarioTemplateDefinition[] = [
  ...
  { id: "breakthrough", name: "Przebij się", description: "Przeprowadź co najmniej jednego bohatera przez blokadę do oznaczonej na zielono strefy wyjścia po stronie przeciwników.", objectiveText: "Wejdź dowolnym bohaterem na jedno z zielonych pól strefy wyjścia przed końcem 8. rundy. Nie musisz pokonać wszystkich wrogów.", failureText: "Droga odwrotu została odcięta.", suggestedLevel: { min: 1, max: 3 }, rewardXp: 140, roundLimit: 8, environment: "outdoor", theme: "ruins", monsters: ["hobgoblin-captain", "goblin", "goblin", "worg"], requiresObjectives: false, events: [intro("breakthrough", "Przebij się przez blokadę", "Doprowadź dowolnego bohatera do zielonej strefy wyjścia za linią przeciwników. Eliminacja wszystkich wrogów nie jest wymagana."), { id: "breakthrough-reinforcements", name: "Pościg", trigger: { type: "round-start", round: 5 }, effect: { type: "spawn-monsters", monsterIds: ["dire-wolf"] } }] },
